...
from app.routes.eos import router as eos_router
from app.routes.eos_reports import router as eos_reports_router
...
from app.routes.watchers import router as watchers_router
...
app.include_router(eos_reports_router)
